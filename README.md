[xde-theme -- read me first file.  @DATE]: #
...
The quickest and easiest way to get `xde-theme` up and running
...
This will configure, compile and install `xde-theme` the quickest.
...
[5]: INSTALL
[6]: COPYING
[7]: https://github.com/bbidulock/xde-theme/issues
